...
var I18N_STRINGS = {
  ...
  'onb.s1Note':       { ar: '🔒 بياناتك تبقى على جهازك بالكامل، ولا تُرفع لأي خادم إلا إذا فعّلت مزامنة Google Drive الاختيارية بحسابك أنت.', en: "🔒 Your data stays entirely on your device — never uploaded to any server unless you turn on the optional Google Drive sync, with your own account." },
  ...
  'onb.s3Li2':        { ar: '<b>🔁 تحويل بين المحافظ</b> — وتسجيل بأي تاريخ تختاره.', en: '<b>🔁 Transfer between wallets</b> — logged with any date you choose.' },
  ...
  'onb.s5Li2':        { ar: '<b>👈 سحب للحذف + تراجع</b> — احذف معاملة بسحبة، وارجع خطوة خلال ٥ ثوانٍ إذا غيّرت رأيك.', en: '<b>👈 Swipe to delete + undo</b> — delete a transaction with a swipe, and undo within 5 seconds if you change your mind.' },
  ...
  'onb.s7Li1':        { ar: '<b>🌐 لغتان: عربي/English</b> — بدّلها من ⚙ الإعدادات.', en: '<b>🌐 Two languages: Arabic/English</b> — switch from ⚙ Settings.' },
