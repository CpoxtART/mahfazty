...
var I18N_STRINGS = {
  ...
  'qn.ph':            { ar: '@رغبات\nقهوة ١٥ @كاش\nغداء ٤٥\nرحلة ٣٠ @اوبر\nراتب ٥٠٠٠ +', en: '@wishlist\nCoffee 15 @cash\nLunch 45\nRide 30 @uber\nSalary 5000 +' },
  'qn.sideHint':      { ar: '💡 سطر لكل معاملة: <b>الوصف وسعره</b> (مثل «قهوة ١٥»). أضِف <b>+</b> للدخل.<br>👛 لفرز المحافظ <b>قبل</b> التحويل اكتب <b>@المحفظة</b> (سطر مستقل يطبّق على ما تحته، أو داخل السطر): محفظة ميزانية تصير <b>الرئيسية 👛</b>، ومحفظة تتبّع (كاش/أوبر/بطاقات) تُضاف كـ<b>تتبّع 🏦</b> تلقائيًا. مثال: <b>@رغبات @كاش قهوة ١٥</b>.', en: '💡 One line per transaction: <b>description and price</b>. Add <b>+</b> for income.<br>👛 To sort wallets <b>before</b> converting, write <b>@wallet</b> (its own line applies to the lines under it, or inline): a budget wallet becomes the <b>primary 👛</b>, a tracking wallet (cash/uber/cards) is added as <b>tracking 🏦</b>. Example: <b>@wishlist @cash Coffee 15</b>.' },
