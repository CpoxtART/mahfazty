...
var I18N_STRINGS = {
  ...
  'qn.ph':            { ar: '@كاش\nقهوة ١٥\nغداء ٤٥\n@اوبر\nرحلة ٣٠\nراتب ٥٠٠٠ +', en: '@cash\nCoffee 15\nLunch 45\n@uber\nRide 30\nSalary 5000 +' },
  'qn.sideHint':      { ar: '💡 سطر لكل معاملة: <b>الوصف وسعره</b> (مثل «قهوة ١٥»). أضِف <b>+</b> للدخل.<br>👛 لفرز المحافظ <b>قبل</b> التحويل: اكتب سطر محفظة مثل <b>@كاش</b> أو <b>@اوبر</b> فتنطبق على الأسطر تحته — أو ضع <b>@المحفظة</b> داخل أي سطر. تشمل محافظ التتبع (كاش/أوبر/بطاقات).', en: '💡 One line per transaction: <b>description and price</b> (e.g. “Coffee 15”). Add <b>+</b> for income.<br>👛 To sort wallets <b>before</b> converting: write a wallet line like <b>@cash</b> or <b>@uber</b> and it applies to the lines under it — or put <b>@wallet</b> inside any line. Tracking wallets (cash/uber/cards) are included.' },
  ...
  'qn.previewHint':   { ar: '👛 لكل معاملة محفظتها الخاصة — غيّرها من القائمة الذهبية لتوزيعها على محافظ مختلفة. وتقدر تعدّل الوصف/المبلغ، تبدّل النوع (＋/－)، أو تحذف أي سطر.', en: '👛 Each transaction has its own wallet — change it from the gold dropdown to split lines across wallets. You can also edit the description/amount, toggle type (＋/－), or remove a line.' },
