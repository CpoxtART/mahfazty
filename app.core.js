...
const CHANGELOG = [
  {
    version: 'v47.69',
    date: '2026-07-02',
    title: 'العدسات الثلاث المتبقية — الصوت والأرقام والنوافذ',
    items: [
      'عالي: الإدخال الصوتي كان معطوباً بالكامل — أي جملة من أكثر من كلمة («صرفت خمسين على عشاء») كانت تفشل بـ«لم يتم العثور على رقم» لأن التطبيع كان يحذف المسافات قبل تقطيع الكلمات. أُصلح وأضيفت الأعداد المركبة («احد عشر» = 11).',
      'عالي: نافذة تعديل المعاملة كانت تفتح خلف نافذة تفاصيل المحفظة (النقر يبدو بلا أثر) — ترتيب الرسم صار يتبع ترتيب الفتح، وأزرار Escape/الرجوع تغلق النافذة المرئية فعلاً.',
      'متوسط: «قهوة 1,234.56» في الملاحظات السريعة كانت تُسجَّل بمبلغ 56 (فساد صامت) — نمط الأرقام صار يفهم فواصل الآلاف اللاتينية والعربية ٬.',
      'متوسط: حقول المبالغ تحولت من type=number إلى type=text — المتصفح كان يمسح الأرقام العربية-الهندية (١٥٫٥) قبل وصولها للمحلل أصلاً؛ الآن تعمل في كل الحقول.',
      'متوسط: الاستيراد يقصّ التواريخ المستقبلية (ملف من جهاز ساعته متقدمة كان يفسد فرز القوائم وإجماليات الشهر)، وأضيف له حارس التزامن الذي يملكه كل كتّاب المال.',
      'متوسط: التطبيق كان قابلاً للتفاعل قبل اكتمال تحميل البيانات (عبر Tab أو مهلة الـ 6 ثوان) — معاملة تُضاف حينها كانت تُمحى بصمت؛ الآن يرفض الكتابة برسالة واضحة حتى يكتمل التحميل.',
      'ترجمة: 4 تسميات وصول (aria) كانت تبقى عربية في الوضع الإنجليزي أُصلحت، سهمان معكوسان في النص الإنجليزي، وأسماء الألوان تتحدث فور تبديل اللغة.',
      'وصول: منتقيات المحافظ كانت صمّاء لقارئات الشاشة (فلتر النقرات الاصطناعية) — صارت تفرق بين صدى لوحة المفاتيح ونقرة TalkBack/VoiceOver الحقيقية.',
      'تحليلات: مقارنة «عن الشهر الماضي» صارت مقابل نفس الفترة منه (كانت تعرض ▼95% في ثاني يوم من كل شهر)، ومراجعة اليوم تظهر حتى لو بقي التطبيق مفتوحاً عبر منتصف الليل.',
    ],
  },
  {
    version: 'v47.68',
  ...
  },
  {
    ...
    items: [
      'حرج: 15 زراً كانوا معطّلين تماماً بسبب CSP (شارات ⓘ/⚖️ على بطاقات المحافظ، أزرار إدارة المحافظ ✎▲▼🗑، محرر ترتيب الواجهة، زر «سجّل أول دخل»، أزرار الحالة الفارغة في التقارير، قائمة عدد المعاملات) — كانت onclick= داخل HTML مُولَّد برمجياً والمتصفح يحجبها. حُوِّلت كلها إلى ربط برمجي.',
      'عالي: الحفظ المؤجل (400ms) صار يُفرَّغ فوراً عند pagehide وقبل أي إعادة تحميل (تحديث التطبيق/التحديث القسري) — كانت آخر معاملة مسجلة قبل التحديث مباشرة قد تضيع.',
      'عالي: خيار «احتفظ بالمحلية» عند تعارض Drive كان يدمج سراً بيانات السحابة المرفوضة قبل الرفع — الآن يرفع نسختك المحلية فعلاً كما وعد.',
      'عالي: مسودة الملاحظات السريعة صارت تدخل في النسخة الاحتياطية (تصدير/استيراد) — كانت تضيع عند تغيير الجهاز.',
      'متوسط: «تحديث قسري» بدون إنترنت كان يمسح الكاش ويترك التطبيق ميتاً حتى عودة الاتصال — الآن يرفض بأدب.',
      'متوسط: تأكيد «حذف كل البيانات» يوضّح الآن أن الحذف يشمل نسخة Drive وكل الأجهزة المتزامنة.',
      'متوسط: صفوف مفتاح المخطط الدائري كانت ~18px فقط كهدف لمس — رُفعت لحجم قابل للنقر.',
      'متوسط: زر «مزامنة الآن» صار يعرض حالة انشغال ويمنع النقر المزدوج.',
      'تحسينات: مقبض السحب للإغلاق صار قابلاً للإمساك فعلياً (كان 36×4px)، التبويبات تفتح من أعلى الصفحة، تعطيل سحب-للتحديث المزعج في وضع PWA، حقل Client ID لن يُفسده التصحيح التلقائي، تصفير أوضاع الربط يثبت بعد «حذف الكل».',
    ],
  },
  {
    version: 'v47.66',
